...
### pass only good bins index  rather than bins_table_size, bins_mask
...
# output_uri, clr, bin_mask
# has a separate bin filter function that accept filters sequentially applied to the bin matrix return a bin mask
